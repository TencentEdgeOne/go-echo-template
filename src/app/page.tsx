      ...
      <header className="border-b border-gray-800">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <a href="https://github.com/TencentEdgeOne/go-echo-template" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="GitHub">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-4">
            <h1 className="text-5xl font-bold leading-tight">
              Go Functions on EdgeOne Pages - Echo
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Go Functions allow you to run Go web frameworks on EdgeOne Pages.
              This template uses the <code className="text-blue-400">Echo</code> framework
              with middleware, route groups, JSON binding, and dynamic parameters.
            </p>
          </div>
                  ...
                  <CardContent className="pt-5 pb-4 space-y-3">
                    ...
                    {result && (
                      <div className="text-left">
                        <p className="text-xs text-gray-500 mb-1">Response{result.status > 0 ? ` (${result.status})` : ""}:</p>
                        <pre className="text-green-400 font-mono text-xs bg-gray-800 px-3 py-2 rounded overflow-x-auto">{result.data}</pre>
                      </div>
                    )}
                  </CardContent>
                </Card>
